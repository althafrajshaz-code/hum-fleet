...
(async () => {
  ...
  // We need to trigger the error to see the white screen. We don't know the password!
  // Wait, if it crashes after login, maybe we can just set localStorage manually!
  await page.evaluate(() => {
