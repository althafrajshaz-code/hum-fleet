...
app.post('/api/rides/:id/complete', (req, res) => {
  ...
  if (ride) {
    ...
    const totalCollected = finalFare + gst; // Passenger pays distance fare + Tip + 5% GST on distance fare
