...
regex = r'<div style=\{\{ position: \'absolute\', top: \'14px\', right: \'14px\', display: \'flex\', gap: \'8px\', zIndex: 20 \}\}>.*?(?=</div>\s*\{/\* 1\. CENTERED DRIVER PROFILE SECTION \*/})'

replace_str = '''<div style={{ position: 'absolute', top: '14px', right: '14px', display: 'flex', gap: '8px', zIndex: 20 }}>
...
new_content = re.sub(regex, replace_str, content, flags=re.DOTALL)
