...
if (regex.test(content)) { content = content.replace(regex, replaceStr); fs.writeFileSync('src/pages/DriverDashboard.jsx', content); console.log('Fixed header buttons successfully.'); } else { console.log('Regex did not match.'); }
