...
const KERALA_LOCATIONS = [
  // --- 1. ERNAKULAM & KOCHI LOCAL AREAS ---
  { name: "Cochin International Airport (COK), Nedumbassery, Kochi", lat: 10.1520, lng: 76.4019 },
  { name: "Marine Drive & MG Road, Ernakulam, Kochi", lat: 9.9777, lng: 76.2758 },
  { name: "Lulu Mall & Edappally Junction, Kochi", lat: 10.0270, lng: 76.3080 },
  { name: "Infopark Phase 1 & SmartCity, Kakkanad, Kochi", lat: 10.0088, lng: 76.3606 },
  { name: "Fort Kochi Beach & Mattancherry, Kochi", lat: 9.9658, lng: 76.2421 },
  { name: "Vytila Mobility Hub & Junction, Ernakulam", lat: 9.9664, lng: 76.3181 },
  { name: "Kaloor JLN International Stadium & Bus Stand, Kochi", lat: 9.9984, lng: 76.3005 },
  { name: "Ernakulam South Railway Station (ERS) & Junction", lat: 9.9687, lng: 76.2890 },
  { name: "Ernakulam North Railway Station (ERN) & Town", lat: 9.9912, lng: 76.2882 },
  { name: "Aluva Railway Station, KSRTC Stand & Bank Junction", lat: 10.1082, lng: 76.3570 },
  { name: "Angamaly KSRTC Stand & TELK Junction", lat: 10.1960, lng: 76.3860 },
  { name: "Perumbavoor KSRTC Station & Private Bus Stand", lat: 10.1147, lng: 76.4828 },
  { name: "Muvattupuzha KSRTC Stand, PO Junction & Velloorkunnam", lat: 9.9822, lng: 76.5772 },
  { name: "Kothamangalam High Range Junction & College Padi", lat: 10.0594, lng: 76.6214 },
  { name: "Tripunithura Hill Palace, Statue Junction & West Fort", lat: 9.9529, lng: 76.3615 },
  { name: "North Paravur Municipal Junction & KMK Junction", lat: 10.1458, lng: 76.2267 },
  { name: "Kalamassery Premier Junction, CUSAT Gate & University", lat: 10.0469, lng: 76.3181 },
  { name: "Palarivattom Pipeline Junction & Bypass", lat: 10.0039, lng: 76.3078 },
  { name: "Kadavanthra Junction & Elamkulam", lat: 9.9602, lng: 76.2974 },
  { name: "Panampilly Nagar & Giri Nagar, Ernakulam", lat: 9.9615, lng: 76.2885 },
  { name: "Ravipuram & M.G Road South, Ernakulam", lat: 9.9572, lng: 76.2843 },
  { name: "Willingdon Island & Cochin Port Trust", lat: 9.9482, lng: 76.2652 },
  { name: "Thoppumpady Harbour Bridge & Junction", lat: 9.9365, lng: 76.2625 },
  { name: "Palluruthy Veli & Perumpadappu Junction", lat: 9.9190, lng: 76.2730 },
  { name: "Kumbalangi Integrated Tourism Village", lat: 9.8785, lng: 76.2865 },
  { name: "Cherai Beach, Pallippuram & Vypin Island", lat: 10.1416, lng: 76.1784 },
  { name: "Njarakkal Junction & Vypin Coastal Road", lat: 10.0245, lng: 76.2185 },
  { name: "Piravom Town, KSRTC Stand & Railway Station", lat: 9.8710, lng: 76.4950 },
  { name: "Koothattukulam Town & MC Road Junction", lat: 9.8560, lng: 76.5820 },
  { name: "Kolenchery Medical College Junction", lat: 9.9790, lng: 76.4715 },
  { name: "Pattimattom Junction & Kizhakambalam", lat: 10.0125, lng: 76.4420 },

  // --- 2. THIRUVANANTHAPURAM (TRIVANDRUM) LOCAL AREAS ---
  { name: "Technopark Phase 1, 2 & 3, Kazhakkoottam", lat: 8.5581, lng: 76.8816 },
  { name: "Thampanoor Central Station, KSRTC Stand & Overbridge", lat: 8.4862, lng: 76.9523 },
  { name: "East Fort (Kizhakke Kotta), Padmanabhaswamy Temple", lat: 8.4830, lng: 76.9436 },
  { name: "Trivandrum International Airport (TRV), Shangumugham", lat: 8.4821, lng: 76.9200 },
  { name: "Kovalam Lighthouse Beach, Eve's Beach & Samudra", lat: 8.4020, lng: 76.9784 },
  { name: "Varkala Cliff, Papanasam Beach & Railway Station", lat: 8.7356, lng: 76.7032 },
  { name: "Vizhinjam International Seaport, Harbor & Junction", lat: 8.3804, lng: 76.9904 },
  { name: "Nedumangad Town, KSRTC Stand & Market Junction", lat: 8.6015, lng: 77.0018 },
  { name: "Neyyattinkara Town, Railway Station & Hospital Junction", lat: 8.3970, lng: 77.0850 },
  { name: "Attingal KSRTC Bus Stand & Palace Junction", lat: 8.6945, lng: 76.8142 },
  { name: "Peroorkada Junction & Ambalamukku", lat: 8.5305, lng: 76.9662 },
  { name: "Vattiyoorkavu Junction & Mannanthala", lat: 8.5372, lng: 76.9790 },
  { name: "Sreekariyam Junction, College of Engineering (CET)", lat: 8.5475, lng: 76.9165 },
  { name: "Pattom Palace & Plamoodu Junction", lat: 8.5135, lng: 76.9452 },
  { name: "Kowdiar Avenue, Raj Bhavan & Tennis Club", lat: 8.5240, lng: 76.9610 },
  { name: "Palayam Saphalyam Complex, University College", lat: 8.4975, lng: 76.9505 },
  { name: "Vellayambalam Junction & Museum Gardens", lat: 8.5082, lng: 76.9580 },
  { name: "Neyyar Dam, Kattakada & Kallikkad Village", lat: 8.5320, lng: 77.1470 },
  { name: "Poovar Island Resort, Estuary & Boat Club", lat: 8.3180, lng: 77.0670 },
  { name: "Parasala Town, Border Checkpost & Railway Station", lat: 8.3340, lng: 77.1510 },

  // --- 3. KOZHIKODE (CALICUT) LOCAL AREAS ---
  { name: "Kozhikode Beach & SM Street (Mittai Theruvu)", lat: 11.2588, lng: 75.7804 },
  { name: "Palayam Bus Stand & Head Post Office Junction", lat: 11.2490, lng: 75.7830 },
  { name: "Mavoor Road KSRTC Bus Terminal & Medical College Padi", lat: 11.2570, lng: 75.7925 },
  { name: "Calicut International Airport (CCJ), Karipur", lat: 11.1364, lng: 75.9553 },
  { name: "Cyberpark Kozhikode, UL Cyberpark & Nellikode", lat: 11.2725, lng: 75.8360 },
  { name: "Kozhikode Main Railway Station (CLT) & Kallai", lat: 11.2476, lng: 75.7816 },
  { name: "Vadakara Town, Old Bus Stand & Railway Station", lat: 11.6090, lng: 75.5915 },
  { name: "Koyilandy Municipal Stand & Railway Station", lat: 11.4390, lng: 75.6965 },
  { name: "Ramanattukara Bypass Junction & Airport Road", lat: 11.1780, lng: 75.8670 },
  { name: "Feroke Railway Station, Bridge & Old Town", lat: 11.1643, lng: 75.8043 },
  { name: "Mukkam Town, Bus Stand & KMCT Campus", lat: 11.3195, lng: 75.9920 },
  { name: "Balusseri Town & Mukku Junction", lat: 11.4420, lng: 75.8270 },
  { name: "Thamarassery Ghat Pass Gate & Old Town", lat: 11.4170, lng: 75.9370 },
  { name: "Koduvally Town & Jewel Market Junction", lat: 11.3540, lng: 75.9120 },

  // --- 4. THRISSUR LOCAL AREAS ---
  { name: "Thrissur Swaraj Round, West Fort & Vadakkunnathan", lat: 10.5276, lng: 76.2144 },
  { name: "Sakthan Thampuran Bus Stand & Fish Market Junction", lat: 10.5140, lng: 76.2165 },
  { name: "Thrissur Railway Station (TCR) & KSRTC Stand", lat: 10.5186, lng: 76.2147 },
  { name: "Guruvayur Temple East Kada & Railway Station", lat: 10.5946, lng: 76.0384 },
  { name: "Chalakudy KSRTC Stand, Railway Station & Tramway", lat: 10.3070, lng: 76.3315 },
  { name: "Kodungallur Temple, Craft Hospital & Junction", lat: 10.2220, lng: 76.1980 },
  { name: "Kunnamkulam Bus Stand, Town Junction & Market", lat: 10.6510, lng: 76.0715 },
  { name: "Wadakkanchery Railway Station & KSRTC Stand", lat: 10.6620, lng: 76.2510 },
  { name: "Irinjalakuda Town, KSRTC Stand & Temple", lat: 10.3420, lng: 76.2110 },
  { name: "Triprayar Temple & Beach Road Junction", lat: 10.4180, lng: 76.1120 },
  { name: "Manuthy Bypass Junction & Kerala Agricultural Univ", lat: 10.5470, lng: 76.2620 },
  { name: "Ollur Railway Station & Industrial Estate", lat: 10.4780, lng: 76.2370 },
  { name: "Athirappilly Waterfalls & Vazhachal Junction", lat: 10.2850, lng: 76.5698 },

  // --- 5. ALAPPUZHA (ALLEPPEY) LOCAL AREAS ---
  { name: "Alleppey Punnamada Houseboat Jetty & Finishing Point", lat: 9.5006, lng: 76.3456 },
  { name: "Alappuzha Beach, Railway Station & Lighthouse", lat: 9.4912, lng: 76.3195 },
  { name: "Cherthala KSRTC Stand, Private Stand & X'ian College", lat: 9.6860, lng: 76.3320 },
  { name: "Kayamkulam Junction Railway Station & KSRTC Stand", lat: 9.1728, lng: 76.4990 },
  { name: "Marari Beach, Mararikulam North & South", lat: 9.6010, lng: 76.2995 },
  { name: "Ambalapuzha Sri Krishna Temple & Railway Station", lat: 9.3820, lng: 76.3580 },
  { name: "Haripad Subrahmanya Temple & KSRTC Stand", lat: 9.2780, lng: 76.4520 },
  { name: "Mavelikkara Town, Palace & Railway Station", lat: 9.2610, lng: 76.5510 },
  { name: "Kuttanad Ramankary, Champakulam & Pulinkunnoo", lat: 9.4320, lng: 76.4150 },

  // --- 6. KOTTAYAM LOCAL AREAS ---
  { name: "Kottayam KSRTC Bus Station, Seematti & Baker Junction", lat: 9.5916, lng: 76.5322 },
  { name: "Kottayam Railway Station (KTYM) & Nagampadam", lat: 9.5960, lng: 76.5380 },
  { name: "Changanassery Town, Boat Jetty & Railway Station", lat: 9.4470, lng: 76.5360 },
  { name: "Pala KSRTC Stand, Lalam Bridge & River View", lat: 9.7120, lng: 76.6840 },
  { name: "Kanjirappally Town, Jubilee Junction & AKJM Padi", lat: 9.5580, lng: 76.7860 },
  { name: "Ettumanoor Mahadeva Temple & Bypass Junction", lat: 9.6705, lng: 76.5620 },
  { name: "Kumarakom Bird Sanctuary & Tourist Boat Jetty", lat: 9.6175, lng: 76.4300 },
  { name: "Vaikom Mahadeva Temple & Boat Jetty", lat: 9.7490, lng: 76.3940 },
  { name: "Erattupetta Town & Poonjar Palace Road", lat: 9.6830, lng: 76.7830 },
  { name: "Mundakayam Town & High Range Gate Junction", lat: 9.5440, lng: 76.8830 },

  // --- 7. IDUKKI LOCAL AREAS ---
  { name: "Munnar Town Center, KSRTC Stand & Old Munnar", lat: 10.0889, lng: 77.0595 },
  { name: "Thodupuzha KSRTC Stand, Private Stand & Mangattukavala", lat: 9.8960, lng: 76.7160 },
  { name: "Kattappana Town, Bus Stand & ITI Junction", lat: 9.7780, lng: 77.1180 },
  { name: "Thekkady Kumily Town, Periyar Tiger Gate", lat: 9.6023, lng: 77.1648 },
  { name: "Adimali Town & High Range Highway Junction", lat: 10.0210, lng: 76.9530 },
  { name: "Nedumkandam Town & Panchayath Junction", lat: 9.8450, lng: 77.1650 },
  { name: "Cheruthoni Town, Idukki Dam View Point", lat: 9.8433, lng: 76.9744 },

  // --- 8. WAYANAD LOCAL AREAS ---
  { name: "Kalpetta Old Bus Stand, New Stand & Pinangode Road", lat: 11.6103, lng: 76.0827 },
  { name: "Sultan Bathery KSRTC Station & Mysore Highway Junction", lat: 11.6625, lng: 76.2570 },
  { name: "Mananthavady KSRTC Station & Valliyoorkavu Junction", lat: 11.8020, lng: 76.0030 },
  { name: "Vythiri Town, Lakkidi View Point & Ghat Road", lat: 11.5520, lng: 76.0410 },
  { name: "Meppadi Town, Chembra Peak Base & Tea Estates", lat: 11.5470, lng: 76.1260 },
  { name: "Panamaram Town & River Junction", lat: 11.7240, lng: 76.0780 },

  // --- 9. PALAKKAD LOCAL AREAS ---
  { name: "Palakkad Stadium Bus Stand, Fort Junction & Civil Station", lat: 10.7760, lng: 76.6575 },
  { name: "Palakkad Junction Railway Station (Olavakkode/PGT)", lat: 10.7967, lng: 76.6496 },
  { name: "Shoranur Junction Railway Station & KSRTC Stand", lat: 10.7610, lng: 76.2750 },
  { name: "Ottapalam Town, Railway Station & RS Road", lat: 10.7710, lng: 76.3810 },
  { name: "Chittur Town, Anangadi & KSRTC Stand", lat: 10.6970, lng: 76.7440 },
  { name: "Mannarkkad Town, Silent Valley Road & Bus Stand", lat: 10.9880, lng: 76.4580 },
  { name: "Alathur Swathi Junction & Bus Stand", lat: 10.6480, lng: 76.5440 },
  { name: "Pattambi Railway Station & Mele Pattambi", lat: 10.8060, lng: 76.1820 },

  // --- 10. KANNUR LOCAL AREAS ---
  { name: "Kannur Old Bus Stand, Caltex Junction & Railway Station", lat: 11.8740, lng: 75.3710 },
  { name: "Kannur International Airport (CNN), Mattannur", lat: 11.9184, lng: 75.5473 },
  { name: "Thalassery Old Bus Stand, Goods Shed Road & Railway", lat: 11.7490, lng: 75.4890 },
  { name: "Payyanur KSRTC Stand, Perumba & Railway Station", lat: 12.1020, lng: 75.2040 },
  { name: "Taliparamba Highway Junction, Trichambaram & Stand", lat: 12.0420, lng: 75.3580 },
  { name: "Iritty Town, Bus Stand & Coorg Border Highway", lat: 11.9810, lng: 75.6670 },
  { name: "Kuthuparamba Town & Bus Stand", lat: 11.8310, lng: 75.5670 },

  // --- 11. KOLLAM LOCAL AREAS ---
  { name: "Kollam KSRTC Bus Station, Chinnakada & Railway Station", lat: 8.8932, lng: 76.5841 },
  { name: "Karunagappally Bus Stand, Vavvakkavu & Railway", lat: 9.0540, lng: 76.5360 },
  { name: "Punalur KSRTC Bus Stand, Suspension Bridge & Railway", lat: 9.0180, lng: 76.9240 },
  { name: "Kottarakkara KSRTC Stand, Ganapathy Temple & Railway", lat: 9.0010, lng: 76.7720 },
  { name: "Paravur Town, Railway Station & Pozhikkara", lat: 8.8120, lng: 76.6640 },
  { name: "Pathanapuram Town & Bus Stand", lat: 9.0840, lng: 76.8570 },
  { name: "Chadayamangalam Jatayu Earth's Center", lat: 8.8770, lng: 76.8677 },

  // --- 12. MALAPPURAM LOCAL AREAS ---
  { name: "Malappuram KSRTC Bus Stand, Civil Station & Udhayam", lat: 11.0734, lng: 76.0740 },
  { name: "Manjeri Bus Stand, Seethi Haji Stand & IG Road", lat: 11.1215, lng: 76.1217 },
  { name: "Perinthalmanna Bus Stand, Jubilee Junction & Hospital Padi", lat: 10.9780, lng: 76.2260 },
  { name: "Tirur Railway Station, Bus Stand & Ring Road", lat: 10.9152, lng: 75.9238 },
  { name: "Ponnani Bus Stand, Harbor & Chamravattom Bridge", lat: 10.7710, lng: 75.9240 },
  { name: "Kottakkal Arya Vaidya Sala, Bus Stand & Changuvetty", lat: 11.0010, lng: 75.9960 },
  { name: "Kondotty Town & Airport Junction", lat: 11.1480, lng: 75.9620 },
  { name: "Nilambur Town, Railway Station & Teak Museum", lat: 11.2770, lng: 76.2260 },

  // --- 13. PATHANAMTHITTA LOCAL AREAS ---
  { name: "Pathanamthitta KSRTC Bus Station, Aban Junction & Ring Road", lat: 9.2648, lng: 76.7870 },
  { name: "Thiruvalla KSRTC Bus Stand, SCS Junction & Railway Station", lat: 9.3848, lng: 76.5746 },
  { name: "Adoor KSRTC Bus Stand, Revenue Tower & High School Junction", lat: 9.1580, lng: 76.7340 },
  { name: "Ranni Town, Ittiyappara Bus Stand & River View", lat: 9.3810, lng: 76.8120 },
  { name: "Pandalam Palace, Temple Junction & KSRTC", lat: 9.2310, lng: 76.6840 },
  { name: "Kozhencherry Town & Kozhencherry Bridge", lat: 9.3410, lng: 76.7110 },
  { name: "Konni Elephant Reserve & Bus Stand", lat: 9.2450, lng: 76.8520 },

  // --- 14. KASARAGOD LOCAL AREAS ---
  { name: "Kasaragod New Bus Stand, Old Stand & Railway Station", lat: 12.4996, lng: 74.9868 },
  { name: "Kanhangad KSRTC Stand, North Kottacherry & Railway", lat: 12.3160, lng: 75.0930 },
  { name: "Nileshwaram Town, Railway Station & Market", lat: 12.2530, lng: 75.1270 },
