          ...
          <div className="hero-actions animate-fade-in delay-200" style={{ display: 'flex', flexDirection: 'column', gap: '20px', width: '100%', maxWidth: '640px', margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px', width: '100%' }}>
              ...
              <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '20px', textAlign: 'center', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--border)', borderRadius: '16px' }}>
                ...
                <a href="/apks/HUM_Passenger.apk" download style={{ color: '#10b981', fontSize: '13px', fontWeight: 'bold', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginTop: '8px', padding: '8px', background: 'rgba(16, 185, 129, 0.1)', borderRadius: '8px' }}>
              ...
              <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '12px', padding: '20px', textAlign: 'center', background: 'rgba(255, 255, 255, 0.03)', border: '1px solid var(--border)', borderRadius: '16px' }}>
                ...
                <a href="/apks/HUM_Captain.apk" download style={{ color: '#3b82f6', fontSize: '13px', fontWeight: 'bold', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', marginTop: '8px', padding: '8px', background: 'rgba(59, 130, 246, 0.1)', borderRadius: '8px' }}>
